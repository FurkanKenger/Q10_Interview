...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayilardanBuyukMu: "+ortalamaPuanlarVerilenSayilardanBuyukMu(coursesList, 10));
    ...
    public static boolean ortalamaPuanlarVerilenSayilardanBuyukMu(List<Courses> list, double x){
