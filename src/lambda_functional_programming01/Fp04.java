...
public class Fp04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(verilenIkiSayiArasındakiCiftSayilarinToplamini(11, 5));
    ...
    public static int verilenIkiSayiArasındakiCiftSayilarinToplamini(int x, int y) {
        int z = 0;
        if (x > y) {
            z = x;
            x = y;
    ...
    public static int ikiSayiArasindakiTumSayilarinRakamlariToplami(int x, int y) {
        ...
        if (x > y) {
            ...
            return IntStream.rangeClosed(x, y).map(Utils::rakamlarrToplaminiAl).sum();
        }
